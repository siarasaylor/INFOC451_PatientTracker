...
class PresRefills {
    ...
    public static void patientRefills() {
        System.out.println("Prescription Refills");

        //set up items
        JLabel presRefill = new JLabel("Prescription Refills");
        ...
        patientHome = new JFrame("Patient Tracker - Prescription Refills");
